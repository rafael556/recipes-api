...
describe('Recipe Factory', () => {
    ...
    let recipe = new Recipe(recipeDto)
    recipe.recipeId = '';
    recipe.creationDate = '';
    ...
    it('should create recipe model', () => {
        ...
        expect(result.categories).toBe(recipe.categories);
        expect(result.recipeId).toBe('3'); // Verifique se o UUID gerado é '3'
